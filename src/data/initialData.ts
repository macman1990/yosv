...
export const initialPortfolioData: PortfolioData = {
  ...
  servicePackages: [
    {
      id: 'pkg-1',
      name: { en: 'Starter Edit', ar: 'باقة البداية' },
      tagline: { en: 'Fast short-form edits for creators who need momentum', ar: 'تحرير سريع للفيديوهات القصيرة لمن يحتاج إلى زخم متواصل' },
      description: {
        en: 'A streamlined package for short-form content, hooks, captions, and a sharp final export with weekly turnaround.',
        ar: 'باقة مبسطة للمحتوى القصير مع خطافات، ترجمات، وتصدير نهائي سريع مع جدول أسبوعي واضح.',
      },
      price: 250,
      currency: 'USD',
      billing: { en: 'per project', ar: 'لكل مشروع' },
      features: ['1 short-form edit', 'Hook-first pacing', 'Clean captions', '2 rounds of revisions'],
      ctaText: { en: 'Book starter edit', ar: 'احجز الباقة الأساسية' },
      featured: false,
      order: 1,
      visible: true,
      status: 'published',
    ...
    {
      id: 'pkg-2',
      name: { en: 'Growth Retainer', ar: 'باقة النمو' },
      tagline: { en: 'For brands that publish consistently and need better retention', ar: 'للماركات التي تنشر بانتظام وتحتاج إلى محتوى يرفع الاستبقاء' },
      description: {
        en: 'A monthly retainer for content teams that want a reliable editing rhythm, creative direction, and redelivery for multiple short-form assets.',
        ar: 'اشتراك شهري للفرق التي تحتاج إلى إيقاع منتظم في التحرير، توجيه إبداعي، وتقديم محتوى متعدد بشكل موثوق.',
      },
      price: 650,
      currency: 'USD',
      billing: { en: 'per month', ar: 'شهرياً' },
      features: ['4 short-form edits', 'Monthly content planning', 'Sound design & captions', 'Priority turnaround'],
      ctaText: { en: 'Book retainer', ar: 'احجز الاشتراك' },
      featured: true,
      order: 2,
      visible: true,
      status: 'published',
    ...
    {
      id: 'pkg-3',
      name: { en: 'Signature Production', ar: 'الإنتاج المميز' },
      tagline: { en: 'Full-funnel creative work for launches and campaign moments', ar: 'عمل إبداعي متكامل لإطلاقات الحملات والأحداث الكبرى' },
      description: {
        en: 'A premium package for bigger stories, long-form edits, brand-driven motion graphics, and polished campaign material.',
        ar: 'باقة فاخرة للمشاريع الأكبر، الفيديوهات الطويلة، الموشن جرافيكس، ومحتوى الحملة ذات الجودة العالية.',
      },
      price: 1400,
      currency: 'USD',
      billing: { en: 'per campaign', ar: 'لكل حملة' },
      features: ['Long-form edit', 'Campaign motion assets', 'Color grade and audio polish', 'Dedicated creative direction'],
      ctaText: { en: 'Start a campaign', ar: 'ابدأ حملة' },
      featured: false,
      order: 3,
      visible: true,
      status: 'published',
