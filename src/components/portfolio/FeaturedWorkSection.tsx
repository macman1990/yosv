      ...
      return (
        <article key={project.id} className="group grid grid-cols-[96px_1fr_auto] items-center gap-4 rounded-[var(--radius-md)] border border-[var(--border)] bg-[var(--surface)] p-3 shadow-[var(--shadow-sm)] transition-all duration-300 hover:-translate-y-0.5 hover:border-[var(--border-hover)] sm:grid-cols-[132px_1fr_auto]">
          <div className={`relative overflow-hidden rounded-[var(--radius-sm)] bg-black ${getAspectRatioClass(project.aspectRatio)}`}>
            <img src={getResponsiveImageUrl(project.thumbnail, 640)} alt={title} loading="lazy" width={640} height={640} className="h-full w-full object-cover" />
    ...
    return (
      <article key={project.id} data-cursor="video" className="group relative flex h-full flex-col overflow-hidden rounded-[var(--radius-lg)] border border-[var(--border)] bg-[var(--surface)] shadow-[var(--shadow-lg)] transition-all duration-[var(--motion-duration)] hover:-translate-y-1 hover:border-[var(--border-hover)] reveal">
        <div className={`relative w-full overflow-hidden bg-black ${getAspectRatioClass(project.aspectRatio)}`}>
          <img src={getResponsiveImageUrl(project.thumbnail, 800)} alt={title} loading="lazy" width={800} height={800} className="h-full w-full object-cover transition-transform duration-700 ease-out group-hover:scale-105" />
